(function () {
    $(function () {
        ...
        var detailUrl = "/Category/Details";
        var deleteUrl = "/Category/Delete";
        var searchUrl = "/Category/AjaxPage";
        ...
        function getRequest(url) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    writeError("msgErrorAnyModal", "¡Error al consultar los datos de la Categoría!", "error");
                    abp.ui.clearBusy();
                }
            });
        }
        ...
        function refreshList() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    writeError("IndexAlerts", "¡Error al consultar las Categorías!", "error");
                    // abp.ui.clearBusy();
                }
            });
            return false;
        ...
        ////Cellar Details
        //$("a.btnDetailForm").click(function () {
        //    clearErrors();
        //    if (!isEmpty(detailUrl)) {
        //        var id = $(this).attr("data-idEntity");
        //        var url = detailUrl + "/" + id;
        ...
        ////Delete functions
        //$("a.btnDeleteForm").click(function (e) {
        //    clearErrors();
        //    $("#DeleteConfirmation_modal").modal("show");
        //    $("#ItemToDelete_hidden").val($(this).attr("data-idEntity"));
        //    return false;
        //});
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.ErrorCode === okFlag) {
                            writeError("IndexAlerts", "Categoría eliminada correctamente", "success");
                            //$("#tableRowId" + id).remove();
                            refreshList();
                            abp.ui.clearBusy();
                        } else if (data.ErrorCode < noneFlag) {
                            writeError("IndexAlerts", "Error al eliminar la Categoría", "error");
                            abp.ui.clearBusy();
                        }
                    }, error: function(xhr, ajaxOptions, thrownError) {
                        writeError("IndexAlerts", "¡Error al borrar la Categoría!", "error");
                        abp.ui.clearBusy();
                    }
                });
            } return false;
...
function ViewCategoryProcess() {
    var searchDebounceUrl = "/Category/SearchDebounce";
    function writeError(control, msg, type) {
        if (type === "success") {
            abp.notify.success(msg, "");
        } else if (type === "error") {
...
ViewCategoryVariable = new ViewCategoryProcess();